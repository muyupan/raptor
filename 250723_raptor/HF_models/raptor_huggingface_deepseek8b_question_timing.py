...
# --- qdrant ---
client = QdrantClient(url="http://127.0.0.1:6335")
aclient = AsyncQdrantClient(url="http://127.0.0.1:6335")
...
raptor_pack = RaptorPack(
    ...
    similarity_top_k=10,
    mode="collapsed",
    transformations=[SentenceSplitter(chunk_size=3000, chunk_overlap=40)],
)
...
if __name__ == "__main__":
    ...
    out_path = "/scratch1/mfp5696/250713_raptor/250723_raptor/raptor_huggingface_deepseek8b_llama7b.json"
