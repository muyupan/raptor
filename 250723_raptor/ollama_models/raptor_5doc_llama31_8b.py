...
def main():
    ...
    input_dir="/scratch1/mfp5696/250713_raptor/250710_documents_5",
    recursive=True,
    )
    ...
    with io.open (f"/scratch1/mfp5696/250713_raptor/250723_raptor/raptor_5doc_llama31_8b.json", "w") as f:
