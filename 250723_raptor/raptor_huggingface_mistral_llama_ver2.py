...
SMALL_MODEL = "deepseek-ai/DeepSeek-R1-Distill-Llama-8B"
...
# --- answering model ---
THINK_MODEL = "meta-llama/Llama-3.3-70B-Instruct"
...
# Use the pack's query engine and override answering LLM
query_engine = raptor_pack.as_query_engine(llm=thinking_llm)
...
if __name__ == "__main__":
    ...
    # load QA
    qa_pairs = []
    truth_path = "/data/hallucination/250726_muyu/250713_raptor/truth_set_v1_new.csv"
    ...
    out_path = "/data/hallucination/250726_muyu/250713_raptor/250723_raptor/raptor_5doc_deepseek_llama.json"
